...
| Rust crates | `crates/{butler-core,butler-capture,butler-ocr,butler-llm}/` | Pure core + platform crates |
| Desktop app | `apps/desktop/src-tauri/` (crate `butler-desktop`), `apps/desktop/src/` (SolidJS) | The Tauri shell and the overlay |
...
- Use `Glob` to find files by pattern (e.g. `crates/**/*.rs`, `apps/desktop/src/**/*.tsx`, `specs/*/spec.md`)
